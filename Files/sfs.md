...
From called genotypes, we can calculate the SFS by summing all the observations of derived alleles across sites.
```
...
```
Finally we plot the comparison without normalisation but looking at actual counts.
```
